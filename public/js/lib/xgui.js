...
return function ( p ) {
	...
	var font = "12px Arial";
	var fontsm = "10px Arial";

	var EM = 12;
	var EN = 10;
	var textColor = p.textColor || bgColor;
	var darkTextColor = p.darkTextColor || "rgb(0,0,0)";
	...
	this.RangeSlider.prototype.draw = function() {
		...
		// label 1:2
		context.fillStyle = darkTextColor;
		context.font = font;
		context.textBaseline = "alphabetic";
		context.textAlign = "left";
		context.fillText(this.value1.v.toFixed(this.decimals), 0, 9+addy);
	...
	this.TrackPad.prototype.draw = function() {
		...
		context.textBaseline = "alphabetic";
		context.textAlign = "left";
		context.fillText("X: "+this.value1.v.toFixed(2)+" Y: "+this.value2.v.toFixed(2), 0, this.height+EN+1);
	...
	this.Knob.prototype.draw = function() {
		...
		context.textBaseline = "alphabetic";
		context.textAlign = "center";
		context.fillText(this.value.v.toFixed(this.decimals), this.radius, (this.radius*2)+EN-1);
	...
	this.CheckBox.prototype.draw = function() {
		...
		context.textBaseline = "alphabetic";
		context.textAlign = "left";
		context.fillText(this.text, this.fullWidth+4, 9+addy);
		var labelWidth = context.measureText(this.text);
